...
void Essai2()
{
  ...
  { 
    Dimension d(800,600);
    ImageNG i1(2,"boat.bmp",d);
    i1.Affiche();

    ImageNG i2(7,"car.bmp",Dimension(1024,780));
    i2.Affiche();
    
    ImageNG i3(6,"house.bmp",Dimension::FULL_HD);
    i3.Affiche();
  }

  cout << endl << "(3) ***** Test du constructeur d'initialisation partiel *********************************" << endl;
  { 
    ImageNG i1(13,"house.bmp");
    i1.Affiche();
  }

  cout << endl << "(4) ***** Test du constructeur de copie + setters/getters ******************************" << endl;
  { 
    ImageNG i(3,"flowers.bmp",Dimension::VGA);
    cout << "Voici i : " << endl;
    try{
    i.Affiche();

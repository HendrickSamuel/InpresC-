...
int Menu()
{
  ...
  cout << " 2. Tests de importFromBMP, getPixel et exportToBMP de ImageNG" << endl;
...
void Essai1()
{
  ...
  ImageNG image1(1,"test.bmp",Dimension(300,300));
...
//*************************************************************************************************
//*** Test de importFromBMP, getPixel et exportToBMP de ImageNG ************************************* 
//*************************************************************************************************
void Essai2()
{
  cout << endl << "***** (2) Tests de importFromBMP, getPixel et exportToBMP de ImageNG *************************" << endl;
...
void Essai3()
{
  ...
  image.importFromBMP("../images/mandrill.bmp");
  image.Affiche();
  image.Dessine();
